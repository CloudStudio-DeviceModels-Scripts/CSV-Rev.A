...
# Parsing + Configuration Script – CSV - Rev. A

This **Parsing + Configuration** script is designed for the **CSV** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – CSV Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **CSV** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
